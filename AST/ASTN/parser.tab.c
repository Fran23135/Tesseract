...
{
  "$end", "error", "$undefined", "ID", "NUM", "PRINT", "ASSIGN",
  "SEMICOLON", "$accept", "program", "stmt_list", "stmt", "expression", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 44 "parser.y"
    { (yyval.node) = create_node("VariableDeclaration", (yyvsp[(1) - (4)].str), create_node("Value", (yyvsp[(3) - (4)].str), NULL, NULL), NULL); generate_ast_file((yyval.node)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 45 "parser.y"
    { (yyval.node) = create_node("CallExpression", "print", create_node("Arguments", (yyvsp[(2) - (3)].str), NULL, NULL), NULL); generate_ast_file((yyval.node)); ;}
    break;
